...
namespace GlmSharp
{
    ...
    public struct vec2 : IReadOnlyList<float>, IEquatable<vec2>
    {
        ...
        /// </summary>
        public static explicit operator cvec3(vec2 v) => new cvec3((Complex)v.x, (Complex)v.y, 0.0);
        
        /// <summary>
        /// Explicitly converts this to a cvec4. (Higher components are zeroed)
        /// </summary>
        public static explicit operator cvec4(vec2 v) => new cvec4((Complex)v.x, (Complex)v.y, 0.0, 0.0);
        ...
        /// </summary>
        public static vec2 Degrees(vec2 v) => v * 57.295779513082320876798154814105170332405472466564321f;
        ...
        /// </summary>
        public static vec2 Radians(vec2 v) => v * 0.0174532925199432957692369076848861271344287188854172f;
