...
namespace GlmSharp
{
    ...
    public struct ivec3 : IReadOnlyList<int>, IEquatable<ivec3>
    {
        ...
        /// </summary>
        public static explicit operator cvec4(ivec3 v) => new cvec4((Complex)v.x, (Complex)v.y, (Complex)v.z, 0.0);
        ...
        /// <summary>
        /// Returns a ivec3 from component-wise application of operator+ (~~~).
        /// </summary>
