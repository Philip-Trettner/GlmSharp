...
namespace GlmSharp
{
    ...
    public struct decvec4 : IReadOnlyList<decimal>, IEquatable<decvec4>
    {
        ...
        /// Returns a component-wise executed Clamp with scalars.
        /// </summary>
        public static decvec4 Clamp(decimal v, decimal min, decimal max) => new decvec4(Math.Min(Math.Max(v, min), max), Math.Min(Math.Max(v, min), max), Math.Min(Math.Max(v, min), max), Math.Min(Math.Max(v, min), max));
        ...
        /// Returns a component-wise executed Mix with scalars.
        /// </summary>
        public static decvec4 Mix(decimal min, decimal max, decimal a) => new decvec4(min * (1-a) + max * a, min * (1-a) + max * a, min * (1-a) + max * a, min * (1-a) + max * a);
        ...
        /// Returns a component-wise executed Lerp with scalars.
        /// </summary>
        public static decvec4 Lerp(decimal min, decimal max, decimal a) => new decvec4(min * (1-a) + max * a, min * (1-a) + max * a, min * (1-a) + max * a, min * (1-a) + max * a);
        ...
        /// Returns a component-wise executed Smoothstep with scalars.
        /// </summary>
        public static decvec4 Smoothstep(decimal edge0, decimal edge1, decimal v) => new decvec4(((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder3(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder3(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder3(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder3());
        ...
        /// Returns a component-wise executed Smootherstep with scalars.
        /// </summary>
        public static decvec4 Smootherstep(decimal edge0, decimal edge1, decimal v) => new decvec4(((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder5(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder5(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder5(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder5());
    }
}
