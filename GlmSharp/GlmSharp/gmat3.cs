...
{
    [Serializable]
    public struct gmat3<T> : IEnumerable<T>, IEquatable<gmat3<T>>
    {
        // Matrix fields mXY
        ...
        /// </summary>
        public static readonly gmat3<T> Zero = new gmat3<T>(default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T));
