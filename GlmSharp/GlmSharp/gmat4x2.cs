...
namespace GlmSharp
{
    ...
    public struct gmat4x2<T> : IEnumerable<T>, IEquatable<gmat4x2<T>>
    {
        ...
        /// </summary>
        public static readonly gmat4x2<T> Zero = new gmat4x2<T>(default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T));
