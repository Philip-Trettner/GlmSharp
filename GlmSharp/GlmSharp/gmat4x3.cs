...
{
    [Serializable]
    public struct gmat4x3<T> : IEnumerable<T>, IEquatable<gmat4x3<T>>
    {
        // Matrix fields mXY
        public T m00, m01, m02; // Column 0
        public T m10, m11, m12; // Column 1
        public T m20, m21, m22; // Column 2
        public T m30, m31, m32; // Column 3
        ...
        /// </summary>
        public gvec3<T> Column2 => new gvec3<T>(m20, m21, m22);
        
        /// <summary>
        /// Returns the column nr 3
        /// </summary>
        public gvec3<T> Column3 => new gvec3<T>(m30, m31, m32);
        ...
        /// </summary>
        public static readonly gmat4x3<T> Zero = new gmat4x3<T>(default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T), default(T));
