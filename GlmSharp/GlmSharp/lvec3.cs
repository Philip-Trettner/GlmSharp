...
namespace GlmSharp
{
    ...
    public struct lvec3 : IReadOnlyList<long>, IEquatable<lvec3>
    {
        ...
        /// </summary>
        public static lvec3 Zero { get; } = new lvec3(default(long), default(long), default(long));
        ...
        /// </summary>
        public static lvec3 UnitX { get; } = new lvec3(1, default(long), default(long));
        
        /// <summary>
        /// Predefined unit-Y vector
        /// </summary>
        public static lvec3 UnitY { get; } = new lvec3(default(long), 1, default(long));
        
        /// <summary>
        /// Predefined unit-Z vector
        /// </summary>
        public static lvec3 UnitZ { get; } = new lvec3(default(long), default(long), 1);
        ...
        public static bool TryParse(string s, string sep, out lvec3 result)
        {
            ...
            long x = default(long), y = default(long), z = default(long);
        ...
        /// Returns a component-wise executed Clamp with scalars.
        /// </summary>
        public static lvec3 Clamp(long v, long min, long max) => new lvec3(Math.Min(Math.Max(v, min), max), Math.Min(Math.Max(v, min), max), Math.Min(Math.Max(v, min), max));
        ...
        /// Returns a component-wise executed Mix with scalars.
        /// </summary>
        public static lvec3 Mix(long min, long max, long a) => new lvec3(min * (1-a) + max * a, min * (1-a) + max * a, min * (1-a) + max * a);
        ...
        /// Returns a component-wise executed Lerp with scalars.
        /// </summary>
        public static lvec3 Lerp(long min, long max, long a) => new lvec3(min * (1-a) + max * a, min * (1-a) + max * a, min * (1-a) + max * a);
        ...
        /// Returns a component-wise executed Smoothstep with scalars.
        /// </summary>
        public static lvec3 Smoothstep(long edge0, long edge1, long v) => new lvec3(((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder3(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder3(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder3());
        ...
        /// Returns a component-wise executed Smootherstep with scalars.
        /// </summary>
        public static lvec3 Smootherstep(long edge0, long edge1, long v) => new lvec3(((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder5(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder5(), ((v - edge0) / (edge1 - edge0)).Clamp().HermiteInterpolationOrder5());
    }
}
