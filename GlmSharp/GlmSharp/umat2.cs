...
namespace GlmSharp
{
    ...
    public struct umat2 : IReadOnlyList<uint>, IEquatable<umat2>
    {
        ...
        /// </summary>
        public static umat2 Zero { get; } = new umat2(default(uint), default(uint), default(uint), default(uint));
        ...
        /// </summary>
        public static umat2 Identity { get; } = new umat2(1u, default(uint), default(uint), 1u);
