...
namespace GlmSharp
{
    ...
    public struct gmat4x2<T> : IEnumerable<T>, IEquatable<gmat4x2<T>>
    {
        ...
        /// </summary>
        public gmat4x2(gvec2<T> c0, gvec2<T> c1)
        {
            this.m00 = c0.x;
            this.m01 = c0.y;
            this.m10 = c1.x;
