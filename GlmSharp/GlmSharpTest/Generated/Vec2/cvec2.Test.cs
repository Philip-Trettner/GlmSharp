...
namespace GlmSharpTest.Generated.Vec2
{
    ...
    public class ComplexVec2Test
    {
        ...
        {
            {
                var v = new cvec2(new Complex(-6, 4));
                Assert.AreEqual(new Complex(-6, 4), v.x);
                Assert.AreEqual(new Complex(-6, 4), v.y);
            }
            {
                var v = new cvec2(new Complex(-2.5d, -8.5d), new Complex(-3, -7));
                Assert.AreEqual(new Complex(-2.5d, -8.5d), v.x);
                Assert.AreEqual(new Complex(-3, -7), v.y);
            }
            {
                var v = new cvec2(new cvec2(new Complex(8.5d, -4), new Complex(-8, -5)));
                Assert.AreEqual(new Complex(8.5d, -4), v.x);
                Assert.AreEqual(new Complex(-8, -5), v.y);
            }
            {
                var v = new cvec2(new cvec3(new Complex(4, 1.5d), new Complex(-0.5d, 6), new Complex(-5, -7.5d)));
                Assert.AreEqual(new Complex(4, 1.5d), v.x);
                Assert.AreEqual(new Complex(-0.5d, 6), v.y);
            }
            {
                var v = new cvec2(new cvec4(new Complex(5, 5.5d), new Complex(3.5d, -0.5d), new Complex(-9, -9.5d), new Complex(-3, -9)));
        ...
        public void Indexer()
        {
            var v = new cvec2(new Complex(4, 3.5d), new Complex(8.5d, 3.5d));
            ...
            v[1] = new Complex(1.0, -1);
            Assert.AreEqual(new Complex(1.0, -1), v[1]);
            v[0] = new Complex(1.0, -2);
            Assert.AreEqual(new Complex(1.0, -2), v[0]);
            v[0] = new Complex(1.0, -3);
            Assert.AreEqual(new Complex(1.0, -3), v[0]);
        ...
        {
            var v = new cvec2(new Complex(4.5d, 2), new Complex(9.5d, -2));
