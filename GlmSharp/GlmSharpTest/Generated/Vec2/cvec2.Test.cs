...
namespace GlmSharpTest.Generated.Vec2
{
    ...
    public class ComplexVec2Test
    {
        ...
        {
            {
                var v = new cvec2(new Complex(-2, -1));
                Assert.AreEqual(new Complex(-2, -1), v.x);
                Assert.AreEqual(new Complex(-2, -1), v.y);
            }
            {
                var v = new cvec2(new Complex(1.5d, -4), new Complex(6, -7.5d));
                Assert.AreEqual(new Complex(1.5d, -4), v.x);
                Assert.AreEqual(new Complex(6, -7.5d), v.y);
            }
            {
                var v = new cvec2(new cvec2(new Complex(-1, -6.5d), new Complex(-7.5d, 1.0)));
                Assert.AreEqual(new Complex(-1, -6.5d), v.x);
                Assert.AreEqual(new Complex(-7.5d, 1.0), v.y);
            }
            {
                var v = new cvec2(new cvec3(new Complex(1.5d, -5.5d), new Complex(9, -6), new Complex(0.5d, 4.5d)));
                Assert.AreEqual(new Complex(1.5d, -5.5d), v.x);
                Assert.AreEqual(new Complex(9, -6), v.y);
            }
            {
                var v = new cvec2(new cvec4(new Complex(9, 7), new Complex(2, -6), new Complex(0.0, 2.5d), new Complex(0.0, -2)));
        ...
        public void Indexer()
        {
            var v = new cvec2(new Complex(-7, -4), new Complex(1.0, -9.5d));
            ...
            v[0] = new Complex(1.0, 4);
            Assert.AreEqual(new Complex(1.0, 4), v[0]);
            ...
            v[0] = new Complex(2, 7);
            Assert.AreEqual(new Complex(2, 7), v[0]);
            v[0] = new Complex(2, 8);
            ...
            v[0] = new Complex(4, 0.0);
            Assert.AreEqual(new Complex(4, 0.0), v[0]);
            ...
            v[1] = new Complex(5, 9.5d);
            Assert.AreEqual(new Complex(5, 9.5d), v[1]);
            v[0] = new Complex(6, 0.0);
            Assert.AreEqual(new Complex(6, 0.0), v[0]);
            ...
            v[0] = new Complex(7, 2);
            Assert.AreEqual(new Complex(7, 2), v[0]);
            v[1] = new Complex(7, 3);
            ...
            v[1] = new Complex(-1, 3.5d);
            Assert.AreEqual(new Complex(-1, 3.5d), v[1]);
            v[0] = new Complex(-1, 4.5d);
            Assert.AreEqual(new Complex(-1, 4.5d), v[0]);
            ...
            v[0] = new Complex(-3, 0.0);
            Assert.AreEqual(new Complex(-3, 0.0), v[0]);
            v[0] = new Complex(-3, 1.0);
            Assert.AreEqual(new Complex(-3, 1.0), v[0]);
            v[0] = new Complex(-3, 2);
            Assert.AreEqual(new Complex(-3, 2), v[0]);
            v[0] = new Complex(-3, 3);
            Assert.AreEqual(new Complex(-3, 3), v[0]);
            ...
            v[0] = new Complex(-6.5d, -1);
            Assert.AreEqual(new Complex(-6.5d, -1), v[0]);
            v[1] = new Complex(-6.5d, -2);
            Assert.AreEqual(new Complex(-6.5d, -2), v[1]);
            ...
            v[0] = new Complex(-5.5d, -1);
            Assert.AreEqual(new Complex(-5.5d, -1), v[0]);
