...
namespace GlmSharpTest.Generated.Vec3
{
    ...
    public class ComplexVec3Test
    {
        ...
        {
            {
                var v = new cvec3(new Complex(5.5d, 4.5d));
        ...
        public void Indexer()
        {
            var v = new cvec3(new Complex(-7.5d, -8), new Complex(0.5d, 5), new Complex(1.0, 5.5d));
            ...
            v[0] = Complex.One;
            Assert.AreEqual(Complex.One, v[0]);
            v[1] = new Complex(0.0, 0.0);
            Assert.AreEqual(new Complex(0.0, 0.0), v[1]);
            v[1] = new Complex(0.0, 1.0);
            ...
            v[1] = new Complex(0.0, -1);
            Assert.AreEqual(new Complex(0.0, -1), v[1]);
            ...
            v[0] = new Complex(1.0, 7);
            Assert.AreEqual(new Complex(1.0, 7), v[0]);
            ...
            Assert.AreEqual(new Complex(1.0, -8.5d), v[0]);
            v[2] = new Complex(1.0, -7.5d);
            Assert.AreEqual(new Complex(1.0, -7.5d), v[2]);
            ...
            Assert.AreEqual(new Complex(1.0, -1.5d), v[2]);
            ...
            v[2] = new Complex(2, 0.0);
            Assert.AreEqual(new Complex(2, 0.0), v[2]);
            v[1] = new Complex(2, 1.0);
            Assert.AreEqual(new Complex(2, 1.0), v[1]);
            v[1] = new Complex(2, 2);
            ...
            v[1] = new Complex(3, -1.5d);
            Assert.AreEqual(new Complex(3, -1.5d), v[1]);
            ...
            v[0] = new Complex(3, 7.5d);
            Assert.AreEqual(new Complex(3, 7.5d), v[0]);
            v[1] = new Complex(3, 8.5d);
            Assert.AreEqual(new Complex(3, 8.5d), v[1]);
            v[2] = new Complex(3, 9.5d);
            Assert.AreEqual(new Complex(3, 9.5d), v[2]);
            v[2] = new Complex(4, 0.0);
            Assert.AreEqual(new Complex(4, 0.0), v[2]);
            v[2] = new Complex(4, 1.0);
            Assert.AreEqual(new Complex(4, 1.0), v[2]);
            v[1] = new Complex(4, 2);
            ...
            v[1] = new Complex(5, 2.5d);
            Assert.AreEqual(new Complex(5, 2.5d), v[1]);
            v[2] = new Complex(5, 3.5d);
            Assert.AreEqual(new Complex(5, 3.5d), v[2]);
            ...
            v[1] = new Complex(7, -1);
            Assert.AreEqual(new Complex(7, -1), v[1]);
            v[2] = new Complex(7, -2);
            ...
            v[0] = new Complex(7, -5.5d);
            Assert.AreEqual(new Complex(7, -5.5d), v[0]);
            ...
            v[2] = new Complex(7, -0.5d);
            Assert.AreEqual(new Complex(7, -0.5d), v[2]);
            v[2] = new Complex(7, 0.5d);
            Assert.AreEqual(new Complex(7, 0.5d), v[2]);
            ...
            v[2] = new Complex(8, -1.5d);
            Assert.AreEqual(new Complex(8, -1.5d), v[2]);
            ...
            v[2] = new Complex(9, 1.0);
            Assert.AreEqual(new Complex(9, 1.0), v[2]);
            v[1] = new Complex(9, 2);
            ...
            v[0] = new Complex(9, 5);
            Assert.AreEqual(new Complex(9, 5), v[0]);
            v[1] = new Complex(9, 6);
            ...
            v[2] = new Complex(9, -6);
            Assert.AreEqual(new Complex(9, -6), v[2]);
            v[1] = new Complex(9, -7);
            Assert.AreEqual(new Complex(9, -7), v[1]);
            v[1] = new Complex(9, -8);
            Assert.AreEqual(new Complex(9, -8), v[1]);
            ...
            v[1] = new Complex(-1, 0.0);
            Assert.AreEqual(new Complex(-1, 0.0), v[1]);
            v[2] = new Complex(-1, 1.0);
            Assert.AreEqual(new Complex(-1, 1.0), v[2]);
            v[2] = new Complex(-1, 2);
            Assert.AreEqual(new Complex(-1, 2), v[2]);
            v[1] = new Complex(-1, 3);
            Assert.AreEqual(new Complex(-1, 3), v[1]);
            v[1] = new Complex(-1, 4);
            Assert.AreEqual(new Complex(-1, 4), v[1]);
            v[1] = new Complex(-1, 5);
            Assert.AreEqual(new Complex(-1, 5), v[1]);
            v[1] = new Complex(-1, 6);
            ...
            v[0] = new Complex(-1, -1);
            Assert.AreEqual(new Complex(-1, -1), v[0]);
            v[1] = new Complex(-1, -2);
            ...
            v[2] = new Complex(-1, -9.5d);
            Assert.AreEqual(new Complex(-1, -9.5d), v[2]);
            ...
            v[0] = new Complex(-1, 3.5d);
            Assert.AreEqual(new Complex(-1, 3.5d), v[0]);
            v[2] = new Complex(-1, 4.5d);
            Assert.AreEqual(new Complex(-1, 4.5d), v[2]);
            v[1] = new Complex(-1, 5.5d);
            Assert.AreEqual(new Complex(-1, 5.5d), v[1]);
            v[0] = new Complex(-1, 6.5d);
            Assert.AreEqual(new Complex(-1, 6.5d), v[0]);
            ...
            v[2] = new Complex(-2, -8.5d);
            Assert.AreEqual(new Complex(-2, -8.5d), v[2]);
            v[2] = new Complex(-2, -7.5d);
            Assert.AreEqual(new Complex(-2, -7.5d), v[2]);
            ...
            Assert.AreEqual(new Complex(-3, 9), v[1]);
            v[0] = new Complex(-3, -1);
            Assert.AreEqual(new Complex(-3, -1), v[0]);
            v[2] = new Complex(-3, -2);
            Assert.AreEqual(new Complex(-3, -2), v[2]);
            v[0] = new Complex(-3, -3);
            ...
            v[2] = new Complex(-6, 0.0);
            Assert.AreEqual(new Complex(-6, 0.0), v[2]);
            v[2] = new Complex(-6, 1.0);
            Assert.AreEqual(new Complex(-6, 1.0), v[2]);
            v[1] = new Complex(-6, 2);
            Assert.AreEqual(new Complex(-6, 2), v[1]);
            v[0] = new Complex(-6, 3);
            ...
            v[1] = new Complex(-6, -1);
            Assert.AreEqual(new Complex(-6, -1), v[1]);
            v[1] = new Complex(-6, -2);
            Assert.AreEqual(new Complex(-6, -2), v[1]);
            v[1] = new Complex(-6, -3);
            Assert.AreEqual(new Complex(-6, -3), v[1]);
            ...
            v[2] = new Complex(-9, 9.5d);
            Assert.AreEqual(new Complex(-9, 9.5d), v[2]);
            v[2] = new Complex(-9.5d, 0.0);
            Assert.AreEqual(new Complex(-9.5d, 0.0), v[2]);
            ...
            v[2] = new Complex(-3.5d, -1);
            Assert.AreEqual(new Complex(-3.5d, -1), v[2]);
            ...
            Assert.AreEqual(new Complex(-3.5d, -0.5d), v[2]);
            v[2] = new Complex(-3.5d, 0.5d);
            Assert.AreEqual(new Complex(-3.5d, 0.5d), v[2]);
            v[2] = new Complex(-3.5d, 1.5d);
            Assert.AreEqual(new Complex(-3.5d, 1.5d), v[2]);
            ...
            Assert.AreEqual(new Complex(1.5d, 1.0), v[1]);
            v[2] = new Complex(1.5d, 2);
            Assert.AreEqual(new Complex(1.5d, 2), v[2]);
            v[1] = new Complex(1.5d, 3);
            Assert.AreEqual(new Complex(1.5d, 3), v[1]);
            ...
            Assert.AreEqual(new Complex(1.5d, -8.5d), v[2]);
            ...
            v[1] = new Complex(3.5d, 9);
            Assert.AreEqual(new Complex(3.5d, 9), v[1]);
            v[1] = new Complex(3.5d, -1);
            Assert.AreEqual(new Complex(3.5d, -1), v[1]);
            v[1] = new Complex(3.5d, -2);
            Assert.AreEqual(new Complex(3.5d, -2), v[1]);
            ...
            v[2] = new Complex(7.5d, 9);
            Assert.AreEqual(new Complex(7.5d, 9), v[2]);
            v[1] = new Complex(7.5d, -1);
            Assert.AreEqual(new Complex(7.5d, -1), v[1]);
            ...
            v[2] = new Complex(8.5d, 9);
            Assert.AreEqual(new Complex(8.5d, 9), v[2]);
            v[0] = new Complex(8.5d, -1);
            Assert.AreEqual(new Complex(8.5d, -1), v[0]);
